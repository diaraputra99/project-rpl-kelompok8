...
export default function KelolaTokoScreen() {
  ...
  return (
    <div style={{ padding: 24, fontFamily: "sans-serif", maxWidth: 800 }}>
      ...
      {/* Catatan setup DB */}
      <div style={{ marginTop: 24, background: "#FFF9E6", border: "1px solid #ffc107", borderRadius: 10, padding: "14px 18px", fontSize: 12, color: "#856404" }}>
        <strong>⚠️ Setup Database (sekali saja):</strong> Pastikan ada 2 tabel di Supabase:
        <br />• <code>store_settings</code> — kolom: <code>id (int), name, address, phone, description, maps_url, instagram</code>
        <br />• <code>store_hours</code> — kolom: <code>id (int), day, is_open (bool), open_time, close_time, is_24h (bool)</code>
        <br />Insert satu baris awal di <code>store_settings</code> dengan <code>id = 1</code>.
      </div>
    </div>
  );
}